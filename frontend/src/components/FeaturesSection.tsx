...
import { mainSubjects } from '@/data/mockData';
...
export default function FeaturesSection() {
  ...
  // ใช้ mainSubjects จาก mockData โดยตรงและเพิ่ม icon
  const categories = mainSubjects.map(subject => ({
    ...subject,
    icon: getIcon(subject.iconType)
  }));
