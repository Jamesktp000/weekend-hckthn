                ...
                changes: [
                  {
                    ...
                    before: '31 มีนาคม 2568',
                    after: '31 พฤษภาคม 2568'
                  },
                  {
                    type: 'added',
                    field: 'วันเริ่มมีผล',
                    description: 'กำหนดวันเริ่มมีผลของแพคเกจใหม่',
                    before: '-',
                    after: 'เริ่ม 15 พฤษภาคม 2568'
                  },
                  {
                    type: 'added',
                    field: 'ระยะเวลาขายสูงสุด',
                    description: 'กำหนดระยะเวลาขายสูงสุด',
                    before: '-',
                    after: 'สามารถขายได้วันนี้ได้สูงสุด 120 วัน'
                  }
                ]
              }
            ]
...
export const changeLog: ChangeLogEntry[] = [
  {
    ...
    changes: [
      ...
      },
      {
        field: 'วันเริ่มมีผล',
        from: '-',
        to: 'เริ่ม 15 พฤษภาคม 2568'
      },
      {
        field: 'ระยะเวลาขายสูงสุด',
        from: '-',
        to: 'สามารถขายได้วันนี้ได้สูงสุด 120 วัน'
      }
    ]
  }
];
